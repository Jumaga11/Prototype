      ...
      .then((facturas) => {
        ...
        if (facturas.length === 0) {
          ...
          facturas.forEach((factura) => {
            ...
            facturaCard.className = "p-4 border rounded-lg shadow-md bg-yellow flex relative";
          
            facturaCard.innerHTML = `
              <div class="flex-1">
                <p><strong>Factura Numero:</strong> ${factura.id_factura}</p>
              ...
              <div class="flex flex-col items-center justify-center gap-2 absolute right-4 top-1/2 transform -translate-y-1/2">
                <button onclick="editFactura(${factura.id_factura})" title="Editar factura">
                  <img src="img/edit.svg" alt="edit" class="w-6 h-6">
                </button>
                <button onclick="viewFactura(${factura.id_factura})" title="Detalles de factura">
                  <img src="img/details.svg" alt="details" class="w-6 h-6">
                </button>
                <button onclick="confirmDelete(${factura.id_factura})" title="Eliminar factura">
                  <img src="img/delete.svg" alt="delete" class="w-6 h-6">
                </button>
                <button onclick="addProduc('${factura.id_factura}', '${factura.cliente_nombre}', '${factura.usuario_nombre}', '${factura.id_cliente}', '${factura.id_usuario}')" title="Añadir producto">
                  <img src="img/shopping.svg" alt="addproduc" class="w-6 h-6">
                </button>
              </div>
            `;

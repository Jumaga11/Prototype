        ...
        fetch("server_usuario.php", {
            ...
            .then(users => {
                ...
                users.forEach(user => {
                    ...
                    userCard.className = "p-4 border rounded-lg shadow-md bg-yellow flex items-start justify-between";
                    ...
                    userCard.innerHTML = `
                        ...
                        <div class="flex flex-col items-end gap-2">
                            ...
                            <button onclick="editUser(${user.id})" class="hover:text-blue-500 focus:outline-none" title="Editar usuario">
                                <img src="img/edit.svg" alt="edit" class="w-6 h-6">
                            </button>

                            <button onclick="confirmDelete(${user.id})" class="hover:text-red-500 focus:outline-none" title="Eliminar usuario">
                                <img src="img/delete.svg" alt="delete" class="w-6 h-6">
                            </button>

                            <button onclick="goToPermisos(${user.id}, '${user.nombre}')" class="hover:text-green-500 focus:outline-none" title="Permisos usuario">
                                <img src="img/permiso.svg" alt="permiso" class="w-6 h-6">
                            </button>

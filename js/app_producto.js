        ...
        fetch("server_producto.php", {
            ...
            .then(productos => {
                ...
                productos.forEach(producto => {
                    ...
                    productoCard.className = "p-4 border rounded-lg shadow-md bg-yellow flex justify-between";
                    ...
                    productoCard.innerHTML = `
                        ...
                        <div class="flex flex-col justify-center gap-4">
                            <button onclick="editproducto(${producto.id_producto})" 
                            class="hover:text-blue-500 foucs.outline-none">
                                    <img src="img/edit.svg" alt="edit">
                            </button>
                            <button onclick="confirmDelete(${producto.id_producto})" 

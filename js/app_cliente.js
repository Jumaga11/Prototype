...
function fetchClientes() {
    ...
    .then(clientes => {
        ...
        clientes.forEach(cliente => {
            ...
            clienteCard.className = "p-4 border rounded-lg shadow-md bg-yellow flex justify-between";
            ...
            clienteCard.innerHTML = `
                ...
                <div class="flex flex-col justify-center gap-4">
                    <button onclick="editCliente(${cliente.id_cliente})" class="hover:text-blue-500 focus:outline-none">
                        <img src="img/edit.svg" alt="edit" class="w-6 h-6">
                    </button>
                    <button onclick="confirmDelete(${cliente.id_cliente})" class="hover:text-red-500 focus:outline-none">
